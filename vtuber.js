...
loadButton.addEventListener('click',async()=>{
 ...
 const talkButton=document.querySelector('#vtuber-talk');talkButton.disabled=false;talkButton.onclick=()=>{talking=!talking;if(talking){syllableEnd=elapsed;phraseLeft=7;}talkButton.setAttribute('aria-pressed',String(talking));talkButton.textContent=talking?'Parar fala':'Simular fala'};
